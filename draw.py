...
def draw(config: models.ModelConfig):
    train_losses = np.load('losses/{}_train.loss'.format(config.model_name))
    val_losses = np.load('losses/{}_val.loss'.format(config.model_name))
    train_accs = np.load('losses/{}_train.acc'.format(config.model_name))
    val_accs = np.load('losses/{}_val.acc'.format(config.model_name))
    train_times = np.load('losses/{}_train.times'.format(config.model_name))
    epochs = np.load('losses/{}_train.epochs'.format(config.model_name))
